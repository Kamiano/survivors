        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <p className="text-neutral-700 leading-relaxed text-base md:text-lg">
              KNESWO Feminist Initiative provides emergency protection and support for individuals experiencing
violence, displacement, homelessness, arrest, or health emergencies. Our services include psychosocial
support, safety planning, referrals, emergency assistance, and community-based protection systems
grounded in care and solidarity.
            </p>
          </div>
