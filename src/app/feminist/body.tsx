        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <p className="text-neutral-700 leading-relaxed text-base md:text-lg">
              KNESWO Feminist Initiative builds feminist leadership among refugee, migrant, and internally
displaced sex workers through political education, mentorship, peer learning, and movement
building. We support community members to grow into leaders, advocates, and decision-makers
who can influence policy, shape advocacy agendas, and lead grassroots feminist movements.
            </p>
          </div>
