...
export default function MentalWellbeingFocus() {
    return (
        <section
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-6">
                        ...
                        <div className="w-full max-w-xl overflow-hidden shadow-md rounded-sm">
                            <img
                                ...
                                alt="Mental health support session and peer wellness group at Survivors Busia"
                                className="w-full aspect-4/3 object-cover"
                            />
                        </div>

                        <p className="text-neutral-700 leading-relaxed text-base md:text-lg">
                            At Survivors Busia, we recognize that physical safety and legal protection must go hand-in-hand with emotional healing. Sex workers regularly navigate systemic stigma, social isolation, and workplace trauma. We foster a safe, non-judgmental environment offering peer-led counseling, crisis intervention, and mental health resources—empowering our community to heal, build resilience, and restore personal well-being.
                        </p>
                    </div>

                    {/* Right Side: Mental Health Campaign Card */}
