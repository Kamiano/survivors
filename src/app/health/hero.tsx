  ...
  return (
    <div className="relative w-full h-90 sm:h-96 md:h-110 xl:h-135 overflow-hidden flex items-end pb-8">
      ...
      {/* 
        ...
        - Keeps `bg-cover` to ensure the image bleeds edge-to-edge and completely fills the viewport.
        - Anchors focus using `bg-top lg:bg-[center_top_15%]` to prevent critical focal subjects from cropping on wide screens.
        - Uses the expanded `xl:h-135` height for structural uniformity.
      */}
      <div
        ...
        >
          ...
          <div className="flex flex-col w-fit">
            <h1 className="text-3xl md:text-4xl font-bold text-white tracking-wide uppercase leading-tight">
              Expand health and wellness response
            </h1>
