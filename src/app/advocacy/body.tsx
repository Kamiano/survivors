        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <p className="text-neutral-700 leading-relaxed text-base md:text-lg">
              KNESWO Feminist Initiative advocates for the rights, dignity, safety, and inclusion of refugee, migrant,
and internally displaced sex workers by challenging the criminalization of sex work, discriminatory laws,
stigma, violence, and systemic exclusion. We engage in policy dialogue, feminist advocacy campaigns,
documentation of human rights violations, and strategic partnerships to influence inclusive laws and
strengthen human rights protections. We also amplify community voices to ensure meaningful
participation in decision-making spaces at all levels.
            </p>
          </div>
