  ...
  return (
    <div className="relative w-full h-90 sm:h-96 md:h-110 xl:h-135 overflow-hidden flex items-end pb-8">
      ...
      {/* 
        ...
        - Keeps `bg-cover` to guarantee the image fills 100% of the viewport width and height.
        - Employs `bg-top lg:bg-[center_top_15%]` to ensure that primary focal elements do not crop out on large or ultrawide displays.
        - Utilizes the standardized vertical height `xl:h-135` for site-wide uniformity.
      */}
      <div
