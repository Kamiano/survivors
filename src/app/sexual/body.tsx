...
export default function SRHRAndSGBVFocus() {
    return (
        <section
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-6">
                        ...
                        <div className="w-full max-w-xl overflow-hidden shadow-md rounded-sm">
                            <img
                                ...
                                alt="SRHR outreach and SGBV support workshop at Survivors Busia"
                                className="w-full aspect-4/3 object-cover"
                            />
                        </div>

                        <p className="text-neutral-700 leading-relaxed text-base md:text-lg">
                            At Survivors Busia, we champion bodily autonomy and barrier-free access to comprehensive sexual and reproductive healthcare. Operating at a high-volume border corridor, we provide peer-led SRHR education, contraceptive commodities, HIV prevention, and STI screening. Crucially, we maintain immediate support pathways for survivors of Sexual and Gender-Based Violence (SGBV)—offering emergency medical care, PEP/PrEP access, legal aid, and safe spaces free from stigma or discrimination.
                        </p>
                    </div>

                    {/* Right Side: SRHR & SGBV Campaign Card */}
