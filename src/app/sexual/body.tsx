        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <p className="text-neutral-700 leading-relaxed text-base md:text-lg">
             KNESWO Feminist Initiative promotes access to sexual and reproductive health information and
services for sex workers in all their diversities. This includes HIV information, abortion care
information and referrals, menstrual health care, reproductive health education, bodily autonomy
awareness, and advocacy for inclusive, stigma-free health systems. We work to dismantle barriers
that prevent sex workers from accessing dignified and respectful healthcare.
            </p>
          </div>
