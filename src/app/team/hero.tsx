  ...
  return (
    <div className="relative w-full h-90 sm:h-96 md:h-110 xl:h-135 overflow-hidden flex items-end pb-8">
      ...
      {/* 
        ...
        - Retains `bg-cover` so the image always fills 100% of the viewport width and height.
        - Changed `bg-center` to `bg-top` (or custom positioning like `lg:bg-[center_top_20%]`).
          This pins the top of the photo to the ceiling of the hero frame on large monitors, 
          preventing the team's faces from being cropped out.
      */}
      <div
