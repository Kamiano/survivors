  ...
  return (
    <div className="relative w-full h-90 sm:h-96 md:h-110 xl:h-135 overflow-hidden flex items-end pb-8">
      ...
      {/* EMULATED BACKGROUND POSITIONING:
        - Maintains `bg-cover` to fully saturate the layout background.
        - Adds `bg-top lg:bg-[center_top_15%]` to prevent critical graphic subjects/faces from cropping out.
        - Expanded large desktop height to `xl:h-135` to perfectly emulate the layout proportions.
      */}
      <div
      ...
      {/* EMULATED PREMIUM BRAND OVERLAYS:
        - Replaced old mix-blend pink layers with the standardized, high-contrast dark brand signature profile.
      */}
      ...
      <div className="relative z-10 w-3/4 mx-auto px-6 md:px-0 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
        ...
        >
          {/* ABOUT US Title Wrapper (Retained original text) */}
